...
class uFilterPickerMessageStoreConan(ConanFile):
   name = "uFilterPickerMessageStore"
   #version = "0.0.1"
   license = "MIT"
   description = "A destination for picks generated by the Lomax-style filter picker in the UUSS Kubernetes environment."
   url = "https://github.com/uofuseismo/uFilterPickerMessageSTore"
   #topics = ("uFilterPickerMessageStore")
   ...
   def package_info(self):
       self.cpp_info.libs = ["uFilterPickerMessageStore"]
